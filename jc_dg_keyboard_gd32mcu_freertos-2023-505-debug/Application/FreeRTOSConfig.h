...
#define configUSE_IDLE_HOOK				0    //1 使用空闲钩子         0 忽略空闲钩子        //原先设置为1
#define configUSE_TICK_HOOK				0    //1 使用时间片钩子         0忽略时间片钩子        //原先设置为1
#define configCPU_CLOCK_HZ				( SystemCoreClock )
#define configTICK_RATE_HZ				( ( TickType_t ) 1000 )
#define configMAX_PRIORITIES			( 5 )   //可使用的最大优先级
#define configMINIMAL_STACK_SIZE		( ( unsigned short ) 64 )   //最小任务栈，原先是130
#define configTOTAL_HEAP_SIZE			( ( size_t ) ( 6 * 1024 ) )  ////系统总堆栈大小,gd32f103vbt6 最大只有20k
#define configMAX_TASK_NAME_LEN			( 10 )   //任务名称的长度
#define configUSE_TRACE_FACILITY		0	 //1 启用可视化跟踪调试         0不启用
...
#define configUSE_TIMERS				0   	//1 启动软件定时器
